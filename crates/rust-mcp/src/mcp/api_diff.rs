...
use super::models::{
    ApiDiffSymbolRow, ConfidenceAssessment, ConfidenceLevel, CrateApiDiffChange,
    CrateApiDiffChangeType, CrateApiDiffRequest, CrateApiDiffResponse, CrateCoreRow,
...
impl McpServer {
    pub(super) async fn handle_crate_api_diff(
        &self,
