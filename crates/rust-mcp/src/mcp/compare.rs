...
use super::index::InteractionRefreshOutcome;
use super::models::{
    ConfidenceAssessment, ConfidenceLevel, CrateCompareCountsRow, CrateCompareRequest,
    CrateCompareResponse, CrateCompareSide, CrateCompareVersionRow, CrateCoreRow,
...
impl McpServer {
    ...
    pub(super) async fn handle_crate_compare(
        &self,
...
#[cfg(test)]
mod tests {
    use super::{compare_recommendation, maintenance_score};
    use crate::mcp::models::CrateCompareSide;
