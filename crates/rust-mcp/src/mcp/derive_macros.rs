...
use super::models::{
    ConfidenceAssessment, ConfidenceLevel, CrateAttributeMacroEntry, CrateCoreRow,
    CrateDeriveMacroEntry, CrateDeriveMacrosRequest, CrateDeriveMacrosResponse,
    CrateFunctionLikeMacroEntry, CrateVersionSelectionRow, DeriveMacroSourceRow,
    ResponseFreshnessSource,
};
use super::server::McpServer;
use super::utils::{dedupe_strings, normalize_optional, normalize_required};
...
impl McpServer {
    pub(super) async fn handle_crate_derive_macros(
        &self,
