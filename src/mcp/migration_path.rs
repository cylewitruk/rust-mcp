...
use super::models::{
    ConfidenceAssessment, ConfidenceLevel, CrateApiDiffChangeType, CrateApiDiffRequest,
    CrateMigrationAction, CrateMigrationPathRequest, CrateMigrationPathResponse,
};
use super::server::McpServer;
use super::utils::{api_diff_limit, normalize_required};
...
fn rename_candidate<'a>(
    removed_change: &super::models::CrateApiDiffChange,
    changes: &'a [super::models::CrateApiDiffChange],
) -> Option<&'a super::models::CrateApiDiffChange> {
    changes
        .iter()
        .find(|candidate| {
...
fn action_for_change(change: &super::models::CrateApiDiffChange) -> (String, String) {
...
impl McpServer {
    pub(super) async fn handle_crate_migration_path(
        &self,
