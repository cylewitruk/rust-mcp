...
use super::models::{
    ConfidenceAssessment, ConfidenceLevel, DependencyAuditCrateRow, DependencyAuditDependency,
    DependencyAuditIssue, DependencyAuditIssueCategory, DependencyAuditRequest,
    DependencyAuditResponse, DependencyAuditSeverity, DependencyAuditVersionRow,
    ResponseFreshnessSource,
};
use super::server::McpServer;
use super::utils::normalize_required;
...
impl McpServer {
    pub(super) async fn handle_dependency_audit(
        &self,
