...
use super::models::{
    ConfidenceAssessment, ConfidenceLevel, CrateCompatibilityMatrixEntry,
    CrateCompatibilityMatrixRequest, CrateCompatibilityMatrixResponse, CrateCompatibilityRequest,
    CrateCompatibilityResponse, DependencyResolveInputDependency, DependencyResolveRequest,
};
...
impl McpServer {
    pub(super) async fn handle_crate_compatibility(
        &self,
    ...
    pub(super) async fn handle_crate_compatibility_matrix(
        &self,
