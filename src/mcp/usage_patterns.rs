...
use super::models::{
    ConfidenceAssessment, ConfidenceLevel, CrateCoreRow, CrateUsagePattern,
    CrateUsagePatternsRequest, CrateUsagePatternsResponse, CrateUsageSourceRow,
    CrateVersionSelectionRow, ResponseFreshnessSource,
};
use super::server::McpServer;
use super::utils::{normalize_optional, normalize_required, usage_patterns_limit};
...
impl McpServer {
    pub(super) async fn handle_crate_usage_patterns(
        &self,
