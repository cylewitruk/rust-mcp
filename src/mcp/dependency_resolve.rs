...
use super::models::{
    ConfidenceAssessment, ConfidenceLevel, DependencyResolveConflict, DependencyResolveCrateRow,
    DependencyResolveEdgeRow, DependencyResolveFeatureSummary, DependencyResolveInputDependency,
    DependencyResolveRequest, DependencyResolveResolvedDependency,
    DependencyResolveResolvedVersion, DependencyResolveResponse, DependencyResolveVersionRow,
};
use super::server::McpServer;
use super::utils::{dependency_resolve_limit, normalize_required};
...
fn collect_feature_names(value: &serde_json::Value) -> BTreeSet<String> {
    match value {
...
impl McpServer {
    pub(super) async fn handle_dependency_resolve(
        &self,
